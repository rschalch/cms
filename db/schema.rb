...
ActiveRecord::Schema.define(version: 20150806204149) do
  ...
  add_index "pages", ["subject_id"], name: "fk_rails_037a1f92d6", using: :btree
  ...
  add_index "section_edits", ["admin_user_id"], name: "fk_rails_40324713a4", using: :btree
  add_index "section_edits", ["section_id"], name: "fk_rails_3943e82cd4", using: :btree
  ...
  add_index "sections", ["page_id"], name: "fk_rails_b9060f893a", using: :btree
